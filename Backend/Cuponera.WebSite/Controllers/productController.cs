...
namespace Cuponera.WebSite.Controllers
{
    ...
    public class productController : UploadImagesBaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IdProduct,Title,StartDatetime,ExpirationDatetime,CreationDatetime,ModificationDatetime,DeletionDatetime,ImagePath,IdCategory,Description,IdStore, Price")] product product)
        {
            if (ModelState.IsValid)
            {
